...
selected_BioProject_accession <- c(rep("PRJNA1002571", each=54),
                                   "PRJNA512907",
                                   "PRJNA399388") 

organism_name <-                 c(rep("Diceros_bicornis", each=54),
                                   "Diceros_bicornis",
                                   "Diceros_bicornis")
...
#### Change folder name
data_stripped_pre$FOLDER <- "Diceros_bicornis"
...
data_stripped$REFERENCE_FOLDER[data_stripped$FOLDER == "Diceros_bicornis"] <- "Diceros_bicornis"
