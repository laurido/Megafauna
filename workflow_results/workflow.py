...
#genus_list      = ["Loxodonta", "Panthera"] # 1000 uncia pardus done
#genus_list      = ["Diceros"] # 1200 done
#genus_list = ["Panthera"] #4300 tigris 4700 leo done
genus_list = ["Elephas"] # 1100 done
#genus_list = ["Rhinoceros"] # 1300 done
#genus_list      = ["Ceratotherium"] # 3700 done + repeat mask added again
...
#    # A.1 Concatenate autosome VCFs
    ...
    #subprocess.run(["rm", f"/faststorage/project/megaFauna/sa_megafauna/results/{group}/done/" + job_id_concat_chrA])
...
#    #subprocess.run(["rm", f"/faststorage/project/megaFauna/sa_megafauna/results/{group}/done/" + job_id_ADMIXTURE_PLOT])
...
#                                 group                 = group,
#                                 admixture_out         = f"/faststorage/project/megaFauna/sa_megafauna/results/{group}/ADMIXTURE/",
#                                 plot_out              = f"/faststorage/project/megaFauna/sa_megafauna/results/shared/ADMIXTURE/",
#                                 k_min                 = 2,
#                                 k_max                 = 6,
...
#
    ...
    # Read sample IDs from file for a given population SHOULD NEVER BE COMMENTED OUT
        ...
        #subprocess.run(["rm", f"/faststorage/project/megaFauna/sa_megafauna/results/{group}/done/" + job_id_pop_and_missingness])
...
#                                                   done         = f"/faststorage/project/megaFauna/sa_megafauna/results/{group}/done/" + job_id_pop_and_missingness))
        ...
        for sample in sample_dict[pop]:
            ...
            for chrom in subset_chromosomes:
                ...
                #subprocess.run(["rm", f"/faststorage/project/megaFauna/sa_megafauna/results/{group}/done/" + job_id_sample_chrom_beds])
...
#        gwf.target_from_template(job_id_roh_mask, 
#                             roh_mask(roh_file = f"/faststorage/project/megaFauna/sa_megafauna/data/{group}/masking/roh_{pop}.txt",
#                                       roh_bed = f"/faststorage/project/megaFauna/sa_megafauna/data/{group}/masking/roh_mask_{pop}.bed",
#                                       done_prev = f"/faststorage/project/megaFauna/sa_megafauna/results/{group}/done/" + job_id_roh_make,
